...
cl = LINETCR.LINE()
cl.login(token="EojdFnetiefFJ1nCmdwa.evpx2S9ig4v6qls5BZETwG.0fYNTVSl5H+cu+Mw4LyikWpkQk+DT6UDEl7nft6ritM=")
cl.loginResult()
...
Bots=[mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,ki6mid,ki7mid,ki8mid,ki9mid,ki10mid,ki11mid,ki12mid,ki13mid,ki14mid,ki15mid,ki16mid,ki17mid,ki18mid,"u1153d7dacf481b857a40b4b96f37ad5a","u521354d39df80312f6c14012a2cae787"]
admsa = "u1153d7dacf481b857a40b4b96f37ad5a","u521354d39df80312f6c14012a2cae787"
admin = "u1153d7dacf481b857a40b4b96f37ad5a","u521354d39df80312f6c14012a2cae787"
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u1153d7dacf481b857a40b4b96f37ad5a":
                    if "join:" in msg.text:
              ...
              if msg.from_ in admin:
                ...
                if msg.toType == 2:
                    ...
                    for tag in wait["blacklist"]:
                        matched_list+=filter(lambda str: str == tag, gMembMids)
                    if matched_list == []:
                        ki.sendText(msg.to,"ทำความสะอาดกลุ่ม")
                        ki2.sendText(msg.to,"ทำความสะอาดกลุ่ม")
                        return
                    for jj in matched_list:
                        try:
                            ...
                            pass
            elif "ทำความสะอาดกลุ่ม" in msg.text:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("ทำความสะอาดกลุ่ม","")
                    gs = ki.getGroup(msg.to)
                    gs = ki2.getGroup(msg.to)
                    gs = ki3.getGroup(msg.to)
                    gs = ki4.getGroup(msg.to)
                    ...
                    gs = ki17.getGroup(msg.to)
                    gs = ki18.getGroup(msg.to)
                    ki.sendText(msg.to,"เริ่มทำความสะอาด ")
                    ki2.sendText(msg.to,"ทำการทำความสะอาดกลุ่ม.")
