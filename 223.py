...
kt = LINETCR.LINE()
kt.login(token='EouADUY06oO8wDPYD7ma.k+rDc9Xny7uVzWMsLUi6EG.owSMVZqnR+1w6L7niGLDxgWBrg2vMWJO2CfuQCZRKw4=')
kt.loginResult()

ks = LINETCR.LINE()
ks.login(token='EoP1vyLzvFuIbkNxvi37.9NkKAUo9+ZIP2DG1f0DOHW.PkVrTQr29K7+xdZX/88NVpiK7t+OD+BTTFrRErxi2k8=')
ks.loginResult()

ki = LINETCR.LINE()
ki.login(token='Eom5MVSs5X5ZrTniRlWe.53DFkVQNoF7wiBfXCl/fVG.fxpnqbdrSdoqwe9H44nWpwEudaAhqrEZUEEBzGLVPqk=')
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EolmE4POzf2PnFAofrD2.dHoY7hWnM1xxJ/w35cl0aG.NxBdwLlwW5StwDm+mPVLOV3txWvBzWI442CtM+R3TZw=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="EoLRX4F1KSroh24hdCl1.vqCTuaRRPMG83KXj1Trviq.Wqq/p8xD9VMZsxB0An4ovnrrM4snPnWGlYpBY0XPeeI=")
kc.loginResult()
...
autoleaveroom = []
targets = []
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,"udba7a6d8efcd6d0a4dfe0a7290f15b68"]
admin = ["udba7a6d8efcd6d0a4dfe0a7290f15b68"]
owner = ["udba7a6d8efcd6d0a4dfe0a7290f15b68"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#------------------------------------------------------------------------------------
        ...
        if op.type == 32:
			OWN = "udba7a6d8efcd6d0a4dfe0a7290f15b68"
			if op.param2 in Bots and admin:
				pass
			else:
				Inviter = op.param3.replace("",',')
